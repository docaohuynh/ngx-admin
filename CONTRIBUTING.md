# Contributing to ngxadmin

We would love for you to contribute to ngxadmin and help make it ever better together! :rocket:
...
Help us keep ngxadmin open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `ngxadmin`.
...
* If you have a question about using ngxadmin, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `ngxadmin:master`.
...
we use the git commit messages to **generate the ngxadmin change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/akveo/ngxadmin
[stackoverflow]: https://stackoverflow.com/questions/tagged/ngxadmin
[issues]: https://github.com/akveo/ngxadmin/issues
[new_issue]: https://github.com/akveo/ngxadmin/issues/new
[pulls]: https://github.com/akveo/ngxadmin/pulls
